...
const awards = [
  "🏆 Best Ethiopian Decorator 2024",
  "⭐ 5-Star Google Rated",
  "🌟 Featured in Ethiopian Reporter",
  "💎 Philadelphia's #1 Cultural Decorator",
  "🎖️ Community Choice Award 2023",
  "✨ 500+ Events Decorated",
  "🌍 Serving the Global Ethiopian Diaspora",
  "🏆 Best Ethiopian Decorator 2024",
  "⭐ 5-Star Google Rated",
  "🌟 Featured in Ethiopian Reporter",
];
    ...
    <div className="bg-gold/10 border-y border-gold/20 py-3 overflow-hidden">
      ...
      >
        {awards.concat(awards).map((a, i) => (
          <span key={i} className="text-gold text-sm font-medium flex-shrink-0">
            {a}
          </span>
        ))}
      </motion.div>
